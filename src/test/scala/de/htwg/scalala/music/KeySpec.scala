...
//      val key1 = Key2(60)
//      val key4 = Key2(midiNumber = 60, ticks = 4)
//      val key5 = Key2(midiNumber = 60, ticks = 4, volume = 75)
//    }
...
//      c1 should be(Key2(60, ticks = 16))
//      c2 should be(Key2(60, ticks = 8))
//      c4 should be(Key2(60, ticks = 4))
//      c8 should be(Key2(60, ticks = 8))
//      c16 should be(Key2(60, ticks = 16))
//    }
//    "should be equal if key and time are equal" in {
//      Key2(60) should be(Key2(60))
//      Key2(60).octave should be(Key2(60).octave)
//    }
//    "should have a midiNumber" in {
//      Key2(60).midiNumber should be(60)
//      Key2(60).keynumber should be(0)
//    }
//    "should be easy to convert to the same key in the next or lower octave" in {
//      (c+).midiNumber should be(Key2(72).midiNumber)
//      (c-).midiNumber should be(Key2(48).midiNumber)
//      (c++).midiNumber should be(Key2(84).midiNumber)
//      (c--).midiNumber should be(Key2(36).midiNumber)
//    }
...
//      Key2(60 + 12 * 5).toString should be("c\"\"'")
//      (c++).toString should be("c\"")
//      (c+).toString should be("c'")
//      (c).toString should be("c")
//      (c-).toString should be("c,")
...
//      c * 2 should be(Key2(60, repeat = 2))
//    }
//    "should apply to a pattern" in {
//      c * Pattern(1, 1, 0, 1) should be(Key2(60, pattern = Pattern(1, 1, 0, 1)))
//    }
//  }
//  "Default Keys" should {
//    "readily be available in the REPL or Worksheet if the package music is imported" in {
//      c should be(Key2(60))
//      cis should be(Key2(61))
//      d should be(Key2(62))
//    }
